 ...
 *
 *
 * SDTIC supports a limited subset of terminfo definitions, sufficient to
 ...
 *     ======================================
 *
 * SD does not use the concept of cancelled strings but must retain
...
int main(int argc, char* argv[]) {
  ...
  printf(
      "#[ SDTIC %s   Copyright, Ladybridge Systems, %s.  All rights reserved. "
      "]\n\n",
...
usage:
  ...
  printf("\n");
  printf("Without -d, SDTIC compiles items from the given source file(s).\n");
